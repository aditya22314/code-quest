...
"[project]/components/ui/ToastProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const axiosInstance = axios.create({
    baseURL: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.BACKEND_URL,
    headers: {
...
const AuthProvider = ({ children })=>{
    ...
    const SignUp = async ({ name, email, password })=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosinstance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/user/signup", {
                name,
                email,
                password
            });
    ...
    const Login = async ({ email, password })=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosinstance$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post("/user/login", {
                email,
                password
            });
            setUser(response.data.data);
...
_s(AuthProvider, "piKxNdN8XnXupdh6mZ53uVwtPB0=");
_c = AuthProvider;
const useAuth = ()=>{
    _s1();
...
//# sourceMappingURL=_37f3b0a7._.js.map