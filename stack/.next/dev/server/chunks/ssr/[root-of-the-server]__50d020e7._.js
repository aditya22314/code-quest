...
"[project]/components/ui/ToastProvider.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const axiosInstance = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: ("TURBOPACK compile-time value", "http://localhost:5001") || "http://localhost:5001",
    headers: {
...
const AuthProvider = ({ children })=>{
    ...
    const SignUp = async ({ name, email, password })=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosinstance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/user/signup", {
                name,
                email,
                password
            });
    ...
    const Login = async ({ email, password })=>{
        try {
            setLoading(true);
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$axiosinstance$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("/user/login", {
                email,
                password
            });
            setUser(response.data);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__50d020e7._.js.map